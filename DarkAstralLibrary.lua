...
local PlayerMouse = Player:GetMouse()
    ...
    Themes = {
        ...
        Purple = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(75, 0, 130)), -- Gradiente roxo escuro
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(100, 0, 150)), -- Gradiente roxo médio
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(75, 0, 130)) -- Gradiente roxo escuro
            }),
            ["Color Hub 2"] = Color3.fromRGB(90, 0, 140), -- Roxo principal do Hub
            ["Color Stroke"] = Color3.fromRGB(0, 0, 0), -- Detalhes em preto
            ["Color Theme"] = Color3.fromRGB(120, 0, 200), -- Tom roxo para o tema
            ["Color Text"] = Color3.fromRGB(255, 255, 255), -- Letras brancas
            ["Color Dark Text"] = Color3.fromRGB(200, 200, 200) -- Texto escuro em cinza claro
        }, 
        DarkRed = {
            ["Color Hub 1"] = ColorSequence.new({
